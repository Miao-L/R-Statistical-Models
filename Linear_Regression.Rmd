...
#From book http://faculty.marshall.usc.edu/gareth-james/ISL/
...
lm.fit
#Summary will print out more detail
summary(lm.fit)
...
# The reason "age" is no longer significant is because all other predictors are highly corrected to "age" 
fit3=lm(medv~., Boston)
summary(fit3)
par(mfrow=c(2,2))
# Plot to check the results
# First chart: Residuals vs Fitted values; we are looking for non-linearity 
plot(fit3)
